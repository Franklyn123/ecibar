...
import * as generador from './generador/generar_asistencias_teoricas';

const img = new Image();
const img2 = new Image();

export function aiv_FIAC(datos) {
  ...
  imageen.imgToBase64(img.src, imagen => {
    ...
    imageen.imgToBase64(img2.src, imagen => {
      ...
      doc.autoTable(col, rows, {
        ...
        columnStyles: {
          nro: { columnWidth: 40 },
          fecha: { columnWidth: 120 },
          horaentrada: { columnWidth: 80 },
          firmaalumno1: { columnWidth: 130 },
          huella1: { columnWidth: 80 },
          horasalida: { columnWidth: 80 },
          firmaalumno2: { columnWidth: 130 },
          huella2: { columnWidth: 80 }
        },
        theme: 'grid'
      });
